---
title: "Trends in Mortality Among Shelter Residents: : Closely Tied To Virus Outbreaks"
subtitle: "Analyzing period: 2007 to 2024"
author: 
  - Mandy He
thanks: "Code and data are available at: https://open.toronto.ca/dataset/deaths-of-shelter-residents/"
date: Septmeber 27 2024
date-format: long
abstract: "Homelessness remain pressing issues in today’s society, particularly evident in downtown Toronto, due to  harsh living conditions, these individuals often face severe health issues, leading to an increased risk of mortality. This paper analyzes the trends in mortality rates among shelter residents in the City of Toronto from 2007 to 2024, highlighting patterns over time and exploring the factors contributing to these rates. This paper found that the trend in the mortality rate of this minority group reflects the overall health conditions in the macro-environment. Therefore, examining these patterns can help improve provisions and reduce the number of deaths among both this vulnerable population and society at large."
format: pdf
