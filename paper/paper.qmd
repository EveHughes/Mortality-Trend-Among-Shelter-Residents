...
Some of our data is of penguins (@fig-Total Number of Death By Year ), from @palmerpenguins.

```{r}
#| label: fig-Total Number of Death By Year 
...
AvgAge_data |> 
  ...
  scale_y_continuous(breaks = seq(0, max(AvgAge_data$total_decedents), by = 5))
