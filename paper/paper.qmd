...
```{r}
#| label: tbl-Table1
#| tbl-cap: Trends in Mortality Rates Among Shelter Residents (2007-2024)
#| echo: false
...
Death_data_filtered |>
  ...
  labs(title = "Trends in Total Decedents by Month(2019-2023)",
       x = "Month-Year",
       y = "Total Decedents") +
  theme_minimal()+
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(plot_data, aes(x = year_short, y = Mortality, fill = Gender)) +
  ...
  labs(title = "Mortality Numbers of Male Vs Female Decedents over 2007 to 2024",
       x = "Year (2000s)",
...
ggplot(avg_age_data, aes(x = year_short, y = Average_Age, color = Gender, group = Gender)) +
  geom_line(size = 1) +   
  geom_point(size = 2) +    
  labs(title = "Average Age of Death for Male Vs Female Decedents",
       x = "Year",
...
plot_2007 <- ggplot(current_year_data_2007, aes(x = month, y = total_decedents)) +
  ...
  labs(title = "Total Decedents by Month in 2007", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45))+
...
plot_2008 <- ggplot(current_year_data_2008, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2008", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45))+
...
plot_2009 <- ggplot(current_year_data_2009, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2009", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2010 <- ggplot(current_year_data_2010, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2010", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2011 <- ggplot(current_year_data_2011, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2011", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2012 <- ggplot(current_year_data_2012, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2012", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2013 <- ggplot(current_year_data_2013, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2013", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2014 <- ggplot(current_year_data_2014, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2014", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2015 <- ggplot(current_year_data_2015, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2015", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2016 <- ggplot(current_year_data_2016, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2016", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2017 <- ggplot(current_year_data_2017, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2017", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2018 <- ggplot(current_year_data_2018, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2018", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2019 <- ggplot(current_year_data_2019, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2019", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2020 <- ggplot(current_year_data_2020, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2020", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2021 <- ggplot(current_year_data_2021, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2021", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2022 <- ggplot(current_year_data_2022, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2022", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2023 <- ggplot(current_year_data_2023, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2023", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
...
plot_2024 <- ggplot(current_year_data_2024, aes(x = month, y = total_decedents)) +
  geom_bar(stat = "identity", fill = "black") +
  labs(title = "Total Decedents by Month in 2024", 
       x = "Month", 
       y = "# Decedents") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45)) +
